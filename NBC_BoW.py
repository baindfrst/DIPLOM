...
X = count_vectorizer.fit_transform(D_alot).toarray()
...
new_X = count_vectorizer.transform(n_t).toarray()
...
file = open("rezult_test\\cyberleninka\\NBC_BoW.txt", 'w', encoding='utf-8')
